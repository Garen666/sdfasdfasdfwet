...
implements ConnectionManager_IDatabaseAdapter, ConnectionManager_IConnection {
    ...
    public function __construct($hostname, $username, $password, $database = false, $encoding = 'unicode', $permanent = true) {
        // проверка
    ...
    public function query($query) {
        ...
        if (PackageLoader::Get()->getMode('debug')) {
            ...
            $statArray['explain'] = mysql_fetch_assoc(SQLObjectConfig::Get()->getDatabaseConnection()->query("EXPLAIN $query"));
            } else {
