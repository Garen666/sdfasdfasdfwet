...
if (!defined('SMARTY_CORE_DIR')) {
    define('SMARTY_CORE_DIR', dirname(__FILE__) . '/internals/');
}
...
class Smarty {
    ...
    public function fetch($resource_name) {
        $code = file_get_contents($resource_name);
    ...
    private function _compile_source($resource_name, &$source_content) {
        ...
        return $smarty_compiler->_compile_file($resource_name, $source_content);
    }
