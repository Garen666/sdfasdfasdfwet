...
class Smarty_Compiler extends Smarty {
     ...
     * @return string
     */
    public function _compile_file($resource_name, $source_content) {
        ...
        for ($curr_tb = 0, $for_max = count($text_blocks); $curr_tb < $for_max; $curr_tb++) {
            ...
            if (preg_match_all('~(<\?(?:\w+|=)?|\?>|language\s*=\s*[\"\']?\s*php\s*[\"\']?)~is', $text_blocks[$curr_tb], $sp_match)) {
                ...
                usort($sp_match[1], array($this, '_smarty_sort_length'));
    ...
    function _compile_registered_object_tag($tag_command, $attrs, $tag_modifier) {
        ...
        // @todo: из-за переделки структуры _reg_objects часть if-конструкций
        // можно нафиг удалить
     ...
     * @return 0|-1|1
     */
    private function _smarty_sort_length($a, $b) {
        if($a == $b) return 0;
