...
// блоки
Engine::GetContentDataSource()->registerContent('block-mymanager', array(
'filehtml' => $templatePath.'/block/block_mymanager.html',
'filephp' => dirname(__FILE__).'/shop/block/block_mymanager.php',
'cache' => array('ttl' => 3600, 'type' => 'content', 'modifiers' => array('language', 'url')),
), 'override');


Engine::GetContentDataSource()->registerContent('block-currency', array(
'filehtml' => $templatePath.'/block/block_currency.html',
'filephp' => dirname(__FILE__).'/shop/block/block_currency.php',
'cache' => array('ttl' => 3600, 'type' => 'content', 'modifiers' => array('language', 'url')),
), 'override');

Engine::GetContentDataSource()->registerContent('block-subscribe', array(
'filehtml' => $templatePath.'/block/block_subscribe.html',
'filephp' => dirname(__FILE__).'/shop/block/block_subscribe.php',
), 'override');

Engine::GetContentDataSource()->registerContent('block-guestbook', array(
'filehtml' => $templatePath.'/block/block_guestbook.html',
'filephp' => dirname(__FILE__).'/shop/block/block_guestbook.php',
'cache' => array('ttl' => 3600, 'type' => 'content', 'modifiers' => array('language', 'url')),
), 'override');

Engine::GetContentDataSource()->registerContent('block-faq', array(
'filehtml' => $templatePath.'/block/block_faq.html',
'filephp' => dirname(__FILE__).'/shop/block/block_faq.php',
'cache' => array('ttl' => 3600, 'type' => 'content', 'modifiers' => array('language', 'url')),
), 'override');

Engine::GetContentDataSource()->registerContent('block-facebook', array(
'filehtml' => $templatePath.'/block/block_facebook.html',
'filephp' => dirname(__FILE__).'/shop/block/block_facebook.php',
'cache' => array('ttl' => 3600, 'type' => 'content', 'modifiers' => array('language', 'url')),
), 'override');
...
Engine::GetContentDataSource()->registerContent('block-search', array(
'filehtml' => $templatePath.'/block/block_search.html',
'filephp' => dirname(__FILE__).'/shop/block/block_search.php',
'cache' => array('ttl' => 3600, 'type' => 'content', 'modifiers' => array('language', 'url')),
), 'override');

Engine::GetContentDataSource()->registerContent('block-menu-category', array(
'filehtml' => $templatePath.'/block/block_menu_category.html',
'filephp' => dirname(__FILE__).'/shop/block/block_menu_category.php',
'cache' => array('ttl' => 3600, 'type' => 'content', 'modifiers' => array('language', 'url')),
), 'override');

Engine::GetContentDataSource()->registerContent('block-menu-textpage', array(
'filehtml' => $templatePath.'/block/block_menu_textpage.html',
'filephp' => dirname(__FILE__).'/shop/block/block_menu_textpage.php',
'cache' => array('ttl' => 3600, 'type' => 'content', 'modifiers' => array('language', 'url')),
), 'override');

Engine::GetContentDataSource()->registerContent('block-category-top', array(
'filehtml' => $templatePath.'/block/block_category_top.html',
'filephp' => dirname(__FILE__).'/shop/block/block_category_top.php',
'cache' => array('ttl' => 3600, 'type' => 'content', 'modifiers' => array('language', 'url')),
), 'override');

Engine::GetContentDataSource()->registerContent('block-feedback', array(
'filehtml' => $templatePath.'/block/block_feedback.html',
'filephp' => dirname(__FILE__).'/shop/block/block_feedback.php',
'cache' => array('ttl' => 3600, 'type' => 'content', 'modifiers' => array('language', 'url')),
), 'override');

Engine::GetContentDataSource()->registerContent('block-footer-category', array(
'filehtml' => $templatePath.'/block/block_footer_category.html',
'filephp' => dirname(__FILE__).'/shop/block/block_footer_category.php',
'cache' => array('ttl' => 3600, 'type' => 'content', 'modifiers' => array('language')),
), 'override');

Engine::GetContentDataSource()->registerContent('block-footer-textpage', array(
'filehtml' => $templatePath.'/block/block_footer_textpage.html',
'filephp' => dirname(__FILE__).'/shop/block/block_footer_textpage.php',
'cache' => array('ttl' => 3600, 'type' => 'content', 'modifiers' => array('language')),
), 'override');
