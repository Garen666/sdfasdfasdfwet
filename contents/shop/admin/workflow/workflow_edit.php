        ...
        try {
            ...
            if ($this->getArgumentSecure('send_edit')) {
                try {
                    ...
                    $category->setSmart($this->getArgumentSecure('smart'));
                    $category->setSmartContent($this->getArgumentSecure('smartContent'));
            ...
            while ($x = $e->getNext()) {
                $ea[] = array(
                    ...
                    'roleid' => $x->getRoleid(),
                    'urlEdit' => Engine::GetLinkMaker()->makeURLByContentIDParam('shop-workflow-status-edit', $x->getId())
                );
            }
            ...
            if ($isBox) {
                ...
                try{
                    $this->setValue('smartContentArray', Engine::Get()->getConfigField('smart-workflow-contents'));
                } catch (Exception $e) {
