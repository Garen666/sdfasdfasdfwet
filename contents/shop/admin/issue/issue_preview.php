        ...
        try {
            ...
            if (Checker::CheckDate($cdate)) {
                if (date("H:i", strtotime($cdate)) == '00:00') {
                    $cdate = date("m.d.Y", strtotime($cdate));
                } else {
                    $cdate = date("m.d.Y в H:i", strtotime($cdate));
                }
            ...
            if (Checker::CheckDate($dateTo)) {
                if (date("H:i", strtotime($dateTo)) == '00:00') {
                    ...
                    $dateTo = date("m.d.Y в H:i", strtotime($dateTo));
                }
            ...
            if ($issue->getOrderProductsCount($issue->getId())) {
                $this->setValue('urlBarcode', Engine::GetLinkMaker()->makeURLByContentIDParam('shop-admin-order-barcode', $issue->getId()));
            }
