<?php
/**
 * Class XShopGame is ORM to table shopGame
 * @author SQLObject
 * @package SQLObject
 */
class XShopGame extends SQLObject {
     ...
     * @return XShopGame
     */
    public static function Get($key) {return self::GetObject("XShopGame", $key);}

}

SQLObject::SetFieldArray('shopGame', array('id', 'name', 'descriptionshort', 'description', 'image', 'hidden', 'deleted', 'url', 'seodescription', 'seotitle', 'seoh1', 'seocontent', 'seokeywords'));
SQLObject::SetPrimaryKey('shopGame', 'id');
