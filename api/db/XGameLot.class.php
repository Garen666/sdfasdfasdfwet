<?php
/**
 * Class XGameLot is ORM to table gameLots
 * @author SQLObject
 * @package SQLObject
 */
class XGameLot extends SQLObject {
     ...
     * @return XGameLot
     */
    public static function Get($key) {return self::GetObject("XGameLot", $key);}

}

SQLObject::SetFieldArray('gameLots', array('id', 'name', 'description', 'gameId', 'hidden', 'deleted', 'url', 'seodescription', 'seotitle', 'seoh1', 'seocontent', 'seokeywords'));
SQLObject::SetPrimaryKey('gameLots', 'id');
