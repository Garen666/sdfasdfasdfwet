<?php
/**
 * Class XLotType is ORM to table lotType
 * @author SQLObject
 * @package SQLObject
 */
class XLotType extends SQLObject {
     ...
     * @return XLotType
     */
    public static function Get($key) {return self::GetObject("XLotType", $key);}

}

SQLObject::SetFieldArray('lotType', array('id', 'name', 'gameId', 'sort', 'hidden', 'deleted', 'url', 'description'));
SQLObject::SetPrimaryKey('lotType', 'id');
