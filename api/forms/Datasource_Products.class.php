...
class Datasource_Products extends Forms_ADataSourceSQLObject {
    ...
    protected function _initialize() {
        ...
        $field->setName(Shop::Get()->getTranslateService()->getTranslateSecure('translate_views'));
    ...
    public function update($key, $fieldsArray) {
        try {
            ...
            try {
                ...
                Shop::Get()->getTranslateService()->getTranslateSecure('translate_edited_product').' #'.$product->getId().' '.$product->getName()."\n".implode("\n", $diffArray),
                $user->getId()
                );
            } catch (Exception $e) {
